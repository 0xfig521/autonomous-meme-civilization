...
- **Degen** - Dogs, cats, aquatic animals, memes, viral degen culture
- **Payments & Wallets** - 支付和钱包基础设施
- **Entertainment & Culture** - 游戏、NFT、体育、媒体消费级应用
- **Explorations** - 多链、RWA、DePIN、全球资产协调
...
1. **只能选择一个赛道** - 不能同时提交多个赛道
2. **Production-ready app** - 项目需为生产级应用
3. **奖金发放** - 一半立即发放，另一半需部署到 mainnet
4. **代码时间限制** - 60天内的代码可以作为 hackathon 项目
...
- **Composition** - 利用 Sui 特性的程度
- **UI/UX** - 用户界面和体验

## Autonomous Meme Civilization 赛道分析
...
1. 注册地址：https://www.deepsurge.xyz/hackathons/b587dc0c-4cb8-4e63-ada5-519df38103bf
2. 提交截止：May 23, 2026
3. Demo Days：June 13 & 14 (需要准备 demo 展示)

## 准备清单

- [ ] 项目 Pitch Deck (10-15 slides)
- [ ] 技术架构文档
- [ ] Demo 视频 (3-5 minutes)
- [ ] GitHub 仓库整理
- [ ] Move 合约说明文档
